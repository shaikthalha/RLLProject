...
public class CanteenMain {
	...
	static RestaurentDAO dao = new RestaurentDAO();
	...
	public static void showRest() {
		List<Restaurent> rest = null;
		try {
			rest = dao.showRestaurent();
		} catch (ClassNotFoundException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		} catch (SQLException e) {
	...
	try {
		rest = dao.searchRestaurent(restaurantID);
	} catch (ClassNotFoundException e) {
		// TODO Auto-generated catch block
		e.printStackTrace();
	} catch (SQLException e) {
